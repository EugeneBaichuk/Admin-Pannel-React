...
export const CardList = () => {
    ...
    return (
        !!cards[0].name && (
            <>
                {cards.map(item => {
                return <ShopCard addCardChangeIsDone={addCardChangeIsDone} changeIsDone={changeIsDone} key={item.id} deleteCard={deleteCard} onMakeActive={onMakeActive} onShowEditForm={onShowEditForm} {...item} />
                })}
